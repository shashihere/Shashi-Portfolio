        ...
        <header className={`nav ${stateClass}`}>
            <div className="nav-inner">
                ...
                <div className="nav-side nav-side-right">
                    ...
                    <a href="https://drive.google.com/file/d/1GlyEzvUqBEgA4RMiminLA56c1ID-aNxJ/view?usp=drive_link" target="_blank" rel="noopener noreferrer" className="nav-cta nav-cta--resume">
            ...
            <div className={`nav-mobile-menu ${isMenuOpen ? "is-open" : ""}`}>
                ...
                <a href="https://drive.google.com/file/d/1GlyEzvUqBEgA4RMiminLA56c1ID-aNxJ/view?usp=drive_link" target="_blank" rel="noopener noreferrer" onClick={() => setIsMenuOpen(false)}>
                    Resume
                </a>
